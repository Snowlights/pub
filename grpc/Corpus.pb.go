...
var fileDescriptor_8d06a1256b80a8c8 = []byte{
	...
	,
}
...
type CorpusServiceClient interface {
	...
	//管理员
	AddAdminUser(ctx context.Context, in *AddAdminUserReq, opts ...grpc.CallOption) (*AddAdminUserReq, error)
	//权限 服务相关
...
func (c *corpusServiceClient) AddAdminUser(ctx context.Context, in *AddAdminUserReq, opts ...grpc.CallOption) (*AddAdminUserReq, error) {
	out := new(AddAdminUserReq)
...
type CorpusServiceServer interface {
	...
	//管理员
	AddAdminUser(context.Context, *AddAdminUserReq) (*AddAdminUserReq, error)
	//权限 服务相关
...
func (*UnimplementedCorpusServiceServer) AddAdminUser(ctx context.Context, req *AddAdminUserReq) (*AddAdminUserReq, error) {
